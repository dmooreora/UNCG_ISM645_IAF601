...
from 'c:\tweets\tweets_2020_09_30.json'
with (CODEPAGE='RAW', FORMATFILE='C:\tweets\BIFormatFile.txt')
...
/****** Object:  UserDefinedFunction [dbo].[parseJSON]    Script Date: 10/1/2020 2:25:50 PM ******/
SET ANSI_NULLS ON
GO
...
GO
    ...
    BEGIN
    begin try
    INSERT INTO [dbo].[TweetJSONStaging]
           ([Country]
           ,[id_str]
           ,[followers_count]
           ,[profile_image_url]
